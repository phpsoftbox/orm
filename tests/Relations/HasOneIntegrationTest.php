...
final class HasOneIntegrationTest extends TestCase
{
    ...
    public function eagerLoadsHasOne(): void
    {
        ...
        self::assertTrue($em->unitOfWork()->isRelationLoaded($items[0], 'profile'));
        self::assertNull($items[1]->profile);
        self::assertTrue($em->unitOfWork()->isRelationLoaded($items[1], 'profile'));
    }
}
