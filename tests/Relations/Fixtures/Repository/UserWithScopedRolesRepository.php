...
/**
 * @extends AbstractEntityRepository<UserWithScopedRoles>
 */
final class UserWithScopedRolesRepository extends AbstractEntityRepository
{
    ...
    {
        return UserWithScopedRoles::class;
    }

    protected function hydrate(array $row): EntityInterface
    {
        return new UserWithScopedRoles(
            id: (int) $row['id'],
    ...
    {
        /** @var UserWithScopedRoles $entity */
        return [
            'id'   => $entity->id,
            'name' => $entity->name,
        ];
    ...
    {
        throw new LogicException('UserWithScopedRolesRepository fixture is read-only.');
    }
